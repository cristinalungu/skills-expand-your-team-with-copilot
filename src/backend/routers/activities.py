...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', 'unspecified')
    """
    ...
    if difficulty:
        if difficulty == "unspecified":
            # "unspecified" means only activities without a difficulty field
